                    ...
                    <div class="widget-content nopadding">
                        <form name="form1" action="" method="post" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="Enter Quantity" name="qty"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="Enter Price" name="price" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="YYYY-MM-DD" name="dt" id="dt" required pattern="\d{4}-\d{2}-\d{2}"/>
                                </div>
                            </div>
