...
<body>
    ...
    <div id="wrapper" style="text-align: center">
        ...
        <div style="display:inline-block; vertical-align: top; border-style:solid; border-width:1px; border-color:green; border-radius:10px; height: 70px; width: 200px; font-size:large; color:white; padding-top:40px; background-color:#ffb848; cursor:pointer;" onclick="window.location='admin/index.php';">Admin Panel</div>
